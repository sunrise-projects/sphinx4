package edu.cmu.sphinx.demo.hitesh;
...
public class HiteshVoiceDemo {
    ...
    private static final String ACOUSTIC_MODEL =
        ...
        private static final String GRAMMAR_PATH =
            "resource:/edu/cmu/sphinx/demo/hitesh/";

        private static final String[] fortuneCookies = new String[] {
        ...
        "You will find a treasure at this web site.",
        ...
        "You are careful & systematic in your business arrangements.",
        "To one who waits, a moment seems a year.",
        "Your wisdom has kept you far away from danger.",
        ...
        "You have a deep appreciation<BR>of the arts and music.",
...
//            
			...
			if(resultText.equalsIgnoreCase("weather"))
 			{
				String filePath = "C:\\lnx1\\home\\ggon\\git-projects\\forecast.txt";
				String content = new String(Files.readAllBytes(Paths.get(filePath)));
				recognizer.stopRecognition();
				voice.invoke(content);
				voice.invoke("Back to you");
				recognizer.startRecognition(true);
 			}
			
			if(resultText.equalsIgnoreCase("fortune"))
 			{
				recognizer.stopRecognition();
				int randomInt = new Random().nextInt(fortuneCookies.length-1);
				String fortuneCookie = fortuneCookies[randomInt];
				voice.invoke(fortuneCookie);
				recognizer.startRecognition(true);
 			}			
